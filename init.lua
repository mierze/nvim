...
vim.keymap.set('n', '<C-d>S', '')
vim.keymap.set('n', '<C-u>S', '')
-- vim.keymap.set({ 'n', 'i', 'v' }, 'C-k', 'C-d')
--TODO:
...
vim.keymap.set('n', '¬', '10l')
vim.keymap.set('n', '˚', '20k') --,
vim.keymap.set('n', '∆', '20j')
vim.keymap.set('n', '<D-l>', '$')
vim.keymap.set('i', '<D-left>', 'g0') -- TODO: have this fire a command to go to end of line
...
vim.keymap.set('n', '<leader>sn', '<C-w><C-w>', { desc = 'Move window' })
...
require('lazy').setup({
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- require('mini.surround').setup { mappings = { add = '{a', delete = '{d', update_n_lines = '{n' } }
      --
